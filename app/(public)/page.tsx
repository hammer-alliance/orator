...
const BLOCKS: FilterBlock[] = [
  { id: 'b1', title: 'Физический базис' },
  { id: 'b2', title: 'Генерация контента' },
]

const TOPICS: FilterTopic[] = [
  { id: 't1', title: 'Дыхание',              block: 'b1' },
  { id: 't2', title: 'Голос и артикуляция',  block: 'b1' },
  { id: 't3', title: 'Структура мысли',      block: 'b2' },
  { id: 't4', title: 'Импровизация',         block: 'b2' },
]
